...
LYSimPhysicsListMessenger::LYSimPhysicsListMessenger(LYSimPhysicsList* pPhys)
    :pPhysicsList(pPhys)
{
...
LYSimPhysicsListMessenger::~LYSimPhysicsListMessenger()
{
    delete pListCmd;
    delete gammaCutCmd;
    delete electCutCmd;
...
void LYSimPhysicsListMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{ 
    if( command == pListCmd )
